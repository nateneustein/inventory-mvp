          ...
          {active.map((po: any) => {
            ...
            return (
              <div key={po.id} className={'shipment-card ' + (noParts ? 'out' : risk.tone)}>
                ...
                {/* Who we buy from. The database already refuses this to anyone
                    without the right role, so these fields simply arrive empty -
                    this keeps an empty grey line off the card as well. */}

...
import { addShipmentSupplier, removeShipmentSupplier } from '@/lib/shipment-actions'
...
<p className="muted small">The main supplier is set in the edit form above. Add the others here when a container is packed from more than one factory.</p>
...
<form className="inline-form push-right" action={removeShipmentSupplier}>
...
<form className="stack card flat" action={addShipmentSupplier}>
<input type="hidden" name="purchase_order_id" value={id} />

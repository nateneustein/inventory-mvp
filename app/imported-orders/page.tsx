...
export default async function ImportedOrdersPage({ searchParams }: { searchParams?: Promise<{ platform?: string, status?: string, dedupe?: string, q?: string }> }) {
    ...
    <>
      ...
      <div className="card table-card">
        ...
        <div className="wide-table"><table>
          ...
          <tbody>
            {rows.map((r:any) => (
              <tr key={r.id} className={r.dedupe_status === 'duplicate' ? 'muted-row' : ''}>
